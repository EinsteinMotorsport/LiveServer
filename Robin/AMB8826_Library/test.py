...
# ----------The speed Test----------
# testLibrary.speed_test_without_address(sender, 10, 3, 1)  # def speed_test_without_address(sender, amountOfData, numberOfValidations, deltaIntervals):
...
# testLibrary.get_single_input_buffer_answer(receiver)
...
# testLibrary.get_single_input_buffer_answer(sender)
